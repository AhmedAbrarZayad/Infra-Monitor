...
OperationalApi? incidentApi(Ref ref){final a=ref.watch(authProvider);final o=ref.watch(organizationContextProvider);return a is AuthAuthenticated&&o is OrganizationReady?OperationalApi(a.accessToken,o.activeMembership.organization.id,client:ref.watch(authenticatedHttpClientProvider)):null;}
