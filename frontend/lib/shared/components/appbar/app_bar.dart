...
class CustomAppBar extends ConsumerStatefulWidget implements PreferredSizeWidget {
  final String title;
  final String role;
  const CustomAppBar({super.key, required this.title, this.role = 'Admin'});
          ...
          child: Row(children: [
            Row(children: [
              AnimatedOpacity(
                ...
                child: Row(children: [
                  Container(width: 8, height: 8, decoration: BoxDecoration(color: AppColors.liveIndicator, shape: BoxShape.circle)),
                ]),
              ),
              const SizedBox(width: 8),
              const Text('Live', style: TextStyle(color: AppColors.liveIndicator)),
            ],),
